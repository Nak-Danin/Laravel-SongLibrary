    ...
    <form method="POST" action="/songs" enctype="multipart/form-data" class="mb-8 animate-fade-up">
        <div class="bg-white rounded-2xl card-glow p-6">
            ...
            <form action="#" method="POST">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <select name="genre"
                            ...
                            <option value="Pop" {{ old('genre') == 'Kpop' ? 'selected' : '' }}>Kpop</option>
                            <option value="Rock" {{ old('genre') == 'Romance' ? 'selected' : '' }}>Romance</option>
                            <option value="Hip-Hop" {{ old('genre') == 'Hip Hop' ? 'selected' : '' }}>Hip Hop</option>
                            <option value="R&B" {{ old('genre') == 'Slowed' ? 'selected' : '' }}>Slowed</option>
                            <option value="Jazz" {{ old('genre') == 'Jazz' ? 'selected' : '' }}>Jazz</option>
                            <option value="Classical" {{ old('genre') == 'Blue' ? 'selected' : '' }}>Blue</option>
                        </select>
                    </div>
                    ...
                    <div>
                        <label class="block text-xs font-display font-semibold text-slate-600 uppercase tracking-wider mb-1.5">Duration</label>
                ...
                <div class="mt-4">
                    <label class="block text-xs font-display font-semibold text-slate-600 uppercase tracking-wider mb-1.5">Notes</label>
